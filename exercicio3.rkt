...
(define-test-suite test-quest3
  (test-equal? "remove primeiro strings"        (remove-primeiro "a" '("a" "b" "c"))  '("b" "c"))
  (test-equal? "remove todos strings"           (remove-todos "a" '("a" "b" "c" "a"))  '("b" "c"))
  (test-equal? "remove primeiro heterogenea"    (remove-primeiro "a" '("a" 1 "c" 2 '("a" "b")))  '(1 "c" 2 '("a" "b")))
  (test-equal? "remove todos heterogenea"       (remove-todos "a" '("a" "b" "c" "a" 1 3))  '("b" "c" 1 3))
  )
